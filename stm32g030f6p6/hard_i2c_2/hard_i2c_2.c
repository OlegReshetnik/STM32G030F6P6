...
void I2C_Init(void) {
	...
	PIN_MODE(I2C2_SCL, MODE_ALT); SET_ALT(I2C2_SCL, 6); // i2c2 alt 6
	SET_SPEED(I2C2_SCL, SPEED_LOW);
	OPEN_DRAIN(I2C2_SCL); //SET_PUP_PUD(I2C2_SCL, PUPD_NO);

	//PORT_CLOCK_ON(I2C2_SDA);
	PIN_MODE(I2C2_SDA, MODE_ALT); SET_ALT(I2C2_SDA, 6); // i2c2 alt 6
	SET_SPEED(I2C2_SDA, SPEED_LOW);
	OPEN_DRAIN(I2C2_SDA); //SET_PUP_PUD(I2C2_SDA, PUPD_NO);
